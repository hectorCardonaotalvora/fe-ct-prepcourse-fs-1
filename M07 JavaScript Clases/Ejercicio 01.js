...
let user = new Usuario("hector", "hector cardona", "etor@gmail.com", "cardona010101");
...
function agregarStringInvertida() {
  ...
  // }
   ...
   //    var palabraInvertido = " ";
  
   //    for (var i=longitud; i>=0; i--){
   //    palabraInvertido = palabraInvertido + palabra.charAt(i);
   //    }  
...
//var Mstr = new agregarStringInvertida("Hello");
//var Mstr = new reverse("Hello");
